...
function getState(val) {
	$.ajax({
	type: "POST",
	url: "http://www.developer.showflipper.com/dropdown_depent/get_allcat.php",
...
#exampleInputEmail1 .form-control:focus
{
	color: #FFF!important;
}
.add-pro-ftr
...
<body >
<form name="basicform" id="basicform" method="post" action="http://www.developer.showflipper.com/administrator/model/new_insert_product.php">
  ...
  <div class="display_form">
    ...
    <div class="panel-body">
		 ...
		 &nbsp;  &nbsp;<h5 style="font-size: 14px;font-weight: bold;font-family: lato,sans-serif;">STEP 1: Basic</h5>
			...
			<div class="row">
		<div class="col-md-2 col-lg-2 col-xl-2 col-sm-12 col-xs-12"> <a href="http://www.developer.showflipper.com/help-center-for-buyer" style="color: #DC5765;font-weight: 550;font-size: 16px;">Need Help?</a></div>
		...
		<div class="text-center restriction_message" style="color:red"></div>
         ...
         <div class="form-group md-form image" style="    BACKGROUND: WHITE;">
			  <div class="image_preview_div">
				 <img src="http://www.developer.showflipper.com/images/photo.png"  id="preview_img1" style="height: 100%;width:100%;" class="preview_img"/>
		  ...
		  <div class="image_preview_div1">
				  <img src="http://www.developer.showflipper.com/images/image.png"  id="preview_img2" style="height:100%;width:100%;" class="preview_img1"/>
			...
			<div class="col-md-3 col-lg-3 col-xl-3 col-sm-12 col-xs-12">
				<div class="form-group md-form image" style="    BACKGROUND: WHITE;">
				<div class="image_preview_div1">
				 <img src="http://www.developer.showflipper.com/images/image.png"  id="preview_img3" style="height:100%;width:100%;"/>
				 ...
				 <div class="form-group md-form image" style="    BACKGROUND: WHITE;">
				 <div class="image_preview_div1">
				 <img src="http://www.developer.showflipper.com/images/image.png"  id="preview_img4" style="height:100%;width:100%;"/>
		  ...
		  <div class="row">
			...
			<div class="col-md-10 col-lg-10 col-xl-10 col-sm-12 col-xs-12">
				 <div class="form-group md-form" style="    margin-bottom: -9px;">
					...
					<br>
				<div class="row">
		<div class="col-md-4 col-lg-4 col-xl-4 col-sm-12 col-xs-12"> <a href="http://www.developer.showflipper.com/help-center-for-buyer" style="color: #DC5765;font-weight: 550;font-size: 16px;">Need Help?</a></div>
...
<div class="modal fade" id="upload_criteria" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
   <div class="modal-dialog" style="width: 940px">
      <div class="modal-content" >	
		...
		<div class="pull-right">
		<button type="button" class="close " data-dismiss="modal" style="    margin-right: 9px;"><img src="http://www.developer.showflipper.com/images/005-unchecked-1.png" style="width: 40px;padding: 2px;"></button>
		</div>
           </div>
			</div>			
			<div class="row">
			...
			<div  style="height:239px; width:860px;background:#f2f2f2; padding: 18px;">
			 <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				...
				<div class="">
		<img src="http://www.developer.showflipper.com/themes/dolphin/images/Group 440.png" class="img-responsive" />
					</div>
				...
				<div class="">
			<img src="http://www.developer.showflipper.com/themes/dolphin/images/1111.png" class="img-responsive" />
					</div>
				...
				<div class="">
			<img src="http://www.developer.showflipper.com/themes/dolphin/images/3333.png" class="img-responsive" />
					</div>
